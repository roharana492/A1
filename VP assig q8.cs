...
public class ArraySearcher
{
    ...
    public void PerformArraySearch()
    {
        Console.WriteLine($"--- 1. Array Search: Find Element in an Array ({ArraySize} Integers) ---");
        int[] numbers = new int[ArraySize];

        // --- Input Loop: Fill the Array ---
...
public class Program
{
    ...
    public static void Main(string[] args)
    {
        ...
        {
            searcher.PerformArraySearch();

            Console.Write("Do you want to search again? Enter Y to continue, or any other key to exit: ");
